...
%and alignments but it will be deleted in order to prevent continual
%appending
...
seq1 = fastaread('Human_PAX.fa');
seq2 = fastaread('Fly_PAX.fa');
%proteinAligned='HOX Alignment';
%matched regions for anchored needlman wunsch later
matched_regions = dlmread('Match_PAX.txt');
